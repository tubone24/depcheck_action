...
const depcheck_1 = __importDefault(__webpack_require__(7086));
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const path = core_1.getInput('path', { required: false }) || '.';
        const unused = yield runDepcheck(path);
        ...
        core_1.info(dependencies);
        core_1.info(devdependencies);
    }
    catch (error) {
...
const makeMarkdownList = (title, list) => {
    let text = '';
    text += `- ${title}\n`;
    list.forEach((l) => {
        text += '  - ${l}\n';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const depcheck_1 = __webpack_require__(6320);
...
var _debug = _interopRequireDefault(__webpack_require__(5957));

var _isCoreModule = _interopRequireDefault(__webpack_require__(6873));

var _lodash = _interopRequireDefault(__webpack_require__(250));

var _readdirp = _interopRequireDefault(__webpack_require__(9556));

var _minimatch = _interopRequireDefault(__webpack_require__(3973));

var _requirePackageName = _interopRequireDefault(__webpack_require__(8705));

var _utils = __webpack_require__(854);

var _parser = _interopRequireDefault(__webpack_require__(9895));

var _typescript = __webpack_require__(8110);

var _constants = __webpack_require__(7507);
...
var _component = _interopRequireDefault(__webpack_require__(9496));
...
var _multimatch = _interopRequireDefault(__webpack_require__(8222));

var _ignore = _interopRequireDefault(__webpack_require__(4214));

var _debug = _interopRequireDefault(__webpack_require__(5957));

var _check = _interopRequireDefault(__webpack_require__(2457));
...
var _util = _interopRequireDefault(__webpack_require__(1669));
...
var _jsYaml = _interopRequireDefault(__webpack_require__(1917));

var _lodash = _interopRequireDefault(__webpack_require__(250));

var _file = __webpack_require__(7088);
...
var _vm = _interopRequireDefault(__webpack_require__(2184));

var _getScripts = _interopRequireDefault(__webpack_require__(4712));
...
module.exports = __webpack_require__(4703)(exports);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __webpack_require__(2308);
} else {
	module.exports = __webpack_require__(8692);
}
...
const sysPath = __webpack_require__(5622);
...
"use strict";
module.exports = JSON.parse("{\"parser\":[\"coffee\",\"es6\",\"es7\",\"jsx\",\"sass\",\"svelte\",\"typescript\",\"vue\"],\"detector\":[\"exportDeclaration\",\"expressViewEngine\",\"extract\",\"gruntLoadTaskCallExpression\",\"importCallExpression\",\"importDeclaration\",\"requireCallExpression\",\"requireResolveCallExpression\",\"typescriptImportEqualsDeclaration\",\"typescriptImportType\"],\"special\":[\"babel\",\"bin\",\"commitizen\",\"eslint\",\"feross-standard\",\"gatsby\",\"gulp-load-plugins\",\"husky\",\"istanbul\",\"jest\",\"karma\",\"lint-staged\",\"mocha\",\"prettier\",\"react17\",\"serverless\",\"tslint\",\"ttypescript\",\"webpack\"]}");
